...
class Sprite:
    ...
    def update(self):
        ...
        # update position
        self.pos[0] = (self.pos[0] + self.vel[0] + 0.0035*score) % WIDTH
        self.pos[1] = (self.pos[1] + self.vel[1] + 0.0035*score) % HEIGHT
...
def click(pos):
    global started, score, lives, hits
...
def rock_spawner():
    ...
    if started and len(rock_group) < 12 and dist(rock_pos, my_ship.get_position()) > 40 + my_ship.get_radius():
